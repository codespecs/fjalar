/*
  ...
  Copyright (C) 2004-2009 Robert Rudd (rudd@csail.mit.edu)
...
/* fjalar_debug.h:
   This file contains some structures and functions to ease writing
   debugging output for Fjalar
*/

#ifndef FJALAR_DEBUG_H
#define FJALAR_DEBUG_H
